    ...
    <section className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="heading-serif text-4xl md:text-5xl text-foreground mb-4">
            What We're Offering
          </h2>
